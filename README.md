...
Iremos responder aos questionamentos.<br><br>
## OBS.: Para plotar os gráficos, faremos uma integração do Python com o Power BI.<br><br>
Todo passo a passo está descrito, meticulosamente, no decorrer da folha de códigos (<font color="blue">Calculos_Financeiros_Empresa.ipynb</font>).
